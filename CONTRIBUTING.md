...
2. **Check for Existing Features**: Before suggesting a new feature, make sure it's not already in the [TO-DO](https://github.com/0Ky/screenclip/blob/dev/TO-DO.md) list.
...
## Code of Conduct
By participating and contributing to this project, you agree to uphold our [Code of Conduct](https://github.com/0Ky/screenclip/blob/dev/CODE_OF_CONDUCT.md).

## Build Instructions
*\* Follow the build instructions from the [dev](https://github.com/0Ky/screenclip#-build-instructions) branch to get started. \**
