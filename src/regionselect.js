...
(async () => {
  ...
  function vidKeydownListener(event) {
    if (event.key === "Escape") {
    ...
    if (event.key === "Enter" || (event.ctrlKey && event.key === "c")) {
      ...
      invoke('video_capture', {x:cropper.getData(true).x, y:cropper.getData(true).y, width:cropper.getData(true).width, height:cropper.getData(true).height});
      document.querySelector("[data-cropper-action='crop']").style.backgroundColor = "transparent";
      document.querySelector("#screenshot").src = "";
      document.querySelector('.cropper-container img').style.display = "none"; // cropper has a copy of the image in another element
      document.querySelector('[alt="The image to preview"]').style.display = "none"; // cropper has a copy of the image in another element

      
      document.querySelector('.cropper-bg').style.background = "transparent"; // cropper has a copy of the image in another element
